...
import type { getArticlesData } from "@/content/queries";

type ArticlesData = Awaited<ReturnType<typeof getArticlesData>>;

export function ArticlesView({ data }: { data: ArticlesData }) {
  const { t } = useTranslation();
  const { results, tags, activeTag, searchQuery, currentPage, totalPages } = data;
  ...
  return (
    <main className="mx-auto min-h-screen max-w-5xl px-6 py-16">
      ...
      {/* Native GET form: re-runs the Server Component with new searchParams. */}
