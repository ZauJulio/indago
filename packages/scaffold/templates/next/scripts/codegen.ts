 ...
 *
 * HyperDown's Next adapter (`@indago/hyper-down/next`) does its half — type
...
import { runHyperDownNextCodegen } from "@indago/hyper-down/next";

const root = process.cwd();

runHyperDownNextCodegen({ root });

const hyperjsonBin = join(root, "node_modules", "@indago/hyper-json/dist/bin/hyperjson.js");
