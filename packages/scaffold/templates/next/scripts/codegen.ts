 ...
 *
 * HyperDown's Next adapter (`@virtus/hyper-down/next`) does its half — type
...
import { runHyperDownNextCodegen } from "@virtus/hyper-down/next";

const root = process.cwd();

runHyperDownNextCodegen({ root });

const hyperjsonBin = join(root, "node_modules", "@virtus/hyper-json/dist/bin/hyperjson.js");
