...
import type { fetchArticles } from "@/server/content";

type ArticlesData = Awaited<ReturnType<typeof fetchArticles>>;
...
export function ArticlesView({ data }: { data: ArticlesData }) {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-5xl px-6 py-16">
      ...
      {/* Native GET form: re-runs the route loader (→ server fn) on submit. */}
