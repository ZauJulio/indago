...
description: "A full tour of HyperJson: Ajv strict validation, in-process type codegen, the generated .hyper-json tree, the hyperjson CLI, the MCP server in Claude Code and opencode, the .agents pack, tests, and the @indago/create-app scaffolds."
date: "2026-06-12"
tags:
...
- [What is HyperJson?](#what-is-hyperjson)
  ...
  - [Why it stays simple](#why-it-stays-simple)
