...
/** SSR: paginated, full-text article search driven by the URL query. */
...
export default function Articles() {
  ...
  const { results, tags, activeTag, searchQuery, currentPage, totalPages } =
  ...
  return (
    <main className="mx-auto min-h-screen max-w-5xl px-6 py-16">
      ...
      {/* Native GET form: re-runs the loader server-side on submit. */}
