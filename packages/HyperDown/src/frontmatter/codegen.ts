...
export class HyperDownCodegen {
  ...
  private generateTypesCode(typeName: string, ct: TypedFrontMatterContentType): string {
    ...
    tsCode += `import type { ContentMeta } from "@virtus/hyper-down/types";\n\n`;
    tsCode += `declare module "@virtus/hyper-down" {\n`;
  ...
  private generateBuilderCode(tableName: string): string {
    ...
    code += `import { createLazyRepository } from "@virtus/hyper-down/server";\n\n`;
    code += `import type { ${interfaceName} } from "@virtus/hyper-down";\n\n`;
  ...
  private generateModulesCode(contentName: string, contentRel: string): string {
    ...
    code += `import type { ContentModuleMap } from "@virtus/hyper-down/types";\n\n`;
